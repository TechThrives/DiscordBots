module.exports = {
  ...
  deletesong: {
    embed: {
      ...
      songDeletedDescription:
        "- La canción **{songName}** ha sido eliminada de la lista de reproducción **{playlistName}**.",
      error: "Error",
  ...
  playCustomPlaylist: {
    embed: {
      ...
      playlistPlaying:
        "- La lista de reproducción **{playlistName}** está reproduciendo ahora.\n- Por favor usa los botones para controlar la reproducción",
