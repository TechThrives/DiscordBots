module.exports = {
  ...
  addsong: {
    embed: {
      ...
      accessDeniedDescription:
        "- Sie haben keine Berechtigung, Lieder zu dieser Playlist hinzuzufügen.",
      songAdded: "Lied Hinzugefügt",
      songAddedDescription:
        "- Das Lied **{songInput}** wurde zur Playlist **{playlistName}** hinzugefügt.",
      error: "Fehler",
      errorDescription:
        "- Beim Hinzufügen des Liedes ist ein Fehler aufgetreten.",
    },
  },
  allplaylists: {
    embed: {
      ...
      noPlaylistsFoundDescription:
        "- Derzeit sind keine öffentlichen Playlists verfügbar.",
      createdBy: "Erstellt von: {userId}",
      serverName: "Server: {serverName}",
      songs: "Lieder: **{songCount}**",
      publicPlaylistsTitle:
        "Öffentliche Playlists (Seite {currentPage}/{totalPages})",
      error: "Fehler",
      errorDescription:
        "- Beim Abrufen der Playlists ist ein Fehler aufgetreten.",
    },
  },
  autoplay: {
    embed: {
      ...
      autoplayStatus:
        "- Die automatische Wiedergabe wurde für diesen Server **{status}**.",
      enabled: "aktiviert",
      disabled: "deaktiviert",
      error: "Fehler",
      errorDescription:
        "- Beim Aktualisieren der automatischen Wiedergabe ist ein Fehler aufgetreten.",
    },
  ...
  createplaylist: {
    embed: {
      ...
      playlistCreatedDescription:
        "- Die Playlist **{playlistName}** wurde erstellt.\n- Sichtbarkeit: **{visibility}**.",
      private: "Privat",
      public: "Öffentlich",
      error: "Fehler",
      errorDescription:
    ...
    commandDescriptionPrivate:
      "Playlist als privat festlegen (nur für Sie sichtbar)",
  },
  deleteplaylist: {
    embed: {
      playlistNotFound: "Playlist Nicht Gefunden",
      ...
      accessDenied: "Zugriff Verweigert",
      accessDeniedDescription:
        "- Sie haben keine Berechtigung, diese Playlist zu löschen.",
      playlistDeleted: "Playlist Gelöscht",
      playlistDeletedDescription:
        "- Die Playlist **{playlistName}** wurde gelöscht.",
      error: "Fehler",
      errorDescription:
  ...
  deletesong: {
    embed: {
      ...
      songDeletedDescription:
        "- Das Lied **{songName}** wurde aus der Playlist **{playlistName}** gelöscht.",
      error: "Fehler",
  ...
  filters: {
    embed: {
      error: "Fehler",
      noPlayer:
        "- Kein aktiver Player gefunden. Bitte spielen Sie zuerst ein Lied ab.",
      wrongChannel:
        "- Sie müssen sich im gleichen Sprachkanal wie der Bot befinden, um diesen Befehl zu nutzen.",
  ...
  myplaylists: {
    embed: {
      ...
      error: "Fehler",
      errorDescription:
        "- Beim Abrufen Ihrer Playlists ist ein Fehler aufgetreten.",
    },
  },
  nowPlaying: {
    embed: {
  ...
  play: {
    embed: {
      error: "Fehler",
      noVoiceChannel:
        "- Sie müssen sich in einem Sprachkanal befinden, um diesen Befehl zu nutzen.",
      noLavalinkNodes:
        "- Keine verfügbaren Lavalink-Nodes zur Verarbeitung der Anfrage.",
  ...
  playCustomPlaylist: {
    embed: {
      ...
      accessDenied: "Zugriff Verweigert",
      noPermission:
        "- Sie haben keine Berechtigung, diese private Playlist abzuspielen.",
      emptyPlaylist: "- Die Playlist ist leer.",
      playingPlaylist: "Playlist wird Abgespielt!",
      playlistPlaying:
        "- Die Playlist **{playlistName}** wird jetzt abgespielt.\n- Bitte nutzen Sie die Schaltflächen zur Steuerung der Wiedergabe",
      errorResolvingSong: "- Fehler beim Auflösen des Liedes.",
      errorPlayingPlaylist:
        "- Beim Abspielen der Playlist ist ein Fehler aufgetreten.",
    },
  ...
  queue: {
    embed: {
      ...
      queueEmptyDescription:
        "- Die Warteschlange ist derzeit leer. Fügen Sie Lieder mit dem `/play`-Befehl hinzu.",
      currentQueue: "Aktuelle Warteschlange",
      noMoreSongs: "- Keine weiteren Lieder in der Warteschlange.",
      error: "Fehler",
      errorDescription:
        "- Beim Abrufen der Warteschlange ist ein Fehler aufgetreten.",
    },
  },
  remove: {
    embed: {
      ...
      invalidPositionDescription:
        "- Ungültige Position. Geben Sie eine Zahl zwischen 1 und {queueLength} ein.",
      songRemoved: "Lied Entfernt",
      songRemovedDescription:
        "- Lied entfernt: **{songTitle}** aus der Warteschlange.",
      error: "Fehler",
      errorDescription:
        "- Beim Entfernen des Liedes aus der Warteschlange ist ein Fehler aufgetreten.",
    },
  },
  resume: {
    embed: {
  ...
  showsongs: {
    embed: {
      ...
      accessDenied: "Zugriff Verweigert",
      noPermission:
        "- Sie haben keine Berechtigung, diese private Playlist anzusehen.",
      noSongs: "- Keine Lieder in dieser Playlist.",
      songsInPlaylist: "Lieder in {playlistName}",
      songsInPlaylistPage:
        "Lieder in {playlistName} (Seite {currentPage}/{totalPages})",
      errorDescription:
        "- Beim Anzeigen der Lieder ist ein Fehler aufgetreten.",
    },
  },
  shuffle: {
    embed: {
      ...
      queueShuffledDescription:
        "- Die Warteschlange wurde erfolgreich gemischt.",
      error: "Fehler",
      errorDescription:
        "- Beim Mischen der Warteschlange ist ein Fehler aufgetreten.",
    },
  },
  skip: {
    embed: {
      ...
      songSkippedDescription:
        "**- Der Player wird das nächste Lied abspielen!**",
      error: "Fehler",
      errorDescription:
        "- Bei der Verarbeitung Ihrer Anfrage ist ein Fehler aufgetreten.",
    },
  ...
  stop: {
    embed: {
      ...
      musicHaltedDescription:
        "**- Die Wiedergabe wurde gestoppt und der Player wurde beendet!**",
      error: "Fehler",
      errorDescription:
        "- Bei der Verarbeitung Ihrer Anfrage ist ein Fehler aufgetreten.",
    },
  ...
  volume: {
    embed: {
      ...
      volumeUpdatedDescription:
        "- Die Lautstärke wurde auf **{volume}%** gesetzt",
      error: "Fehler",
      errorDescription:
        "Bei der Einstellung der Lautstärke ist ein Fehler aufgetreten.",
    },
